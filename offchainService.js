...
const gethTokenBridgeJson = require("./TokenBridge.json");
const bscTokenBridgeJson = require("./TokenBridge.json");
const wrappedTokenJson = require("./WrappedToken.json");
...
async function processEvent(event) {
  ...
  try {
    const receipt = await wrappedToken.methods.mint(user, amount).send({ from: account.address });
